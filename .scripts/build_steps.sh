...
# automatically.
/usr/bin/sudo -n yum install -y xorg-x11-server-Xvfb gtk2-devel libXScrnSaver libXtst alsa-lib mesa-libGL mesa-libEGL gtkmm24 pciutils libselinux mesa-libgbm
